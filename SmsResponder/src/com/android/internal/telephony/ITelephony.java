	...
	public static abstract class Stub extends android.os.Binder implements
		...
		public boolean onTransact(int code, android.os.Parcel data,
			...
			case TRANSACTION_getNeighboringCellInfo: {
				data.enforceInterface(DESCRIPTOR);
				java.util.List<android.telephony.NeighboringCellInfo> _result = this
		...
		private static class Proxy implements
			...
			public boolean showCallScreenWithDialpad(boolean showDialpad)
				...
				try {
					...
					mRemote.transact(
							Stub.TRANSACTION_showCallScreenWithDialpad, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public void silenceRinger() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_silenceRinger, _data,
							_reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public java.util.List<android.telephony.NeighboringCellInfo> getNeighboringCellInfo()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getNeighboringCellInfo,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply
							.createTypedArrayList(android.telephony.NeighboringCellInfo.CREATOR);
				} finally {
					_reply.recycle();
					_data.recycle();
				}
